...
const USER_TEMPLATES = [
  ["admin", "1234", "Administrator", { dashboard: true, daily: true, delivery: true, reports: true, sales: true, clearData: true, editDelivery: true, changeStation: true, refreshCloud: true, users: true }],
  ...
  ["operator", "1111", "Operator", { dashboard: true, daily: true, delivery: true, reports: false, sales: false, clearData: false, editDelivery: false, changeStation: false, refreshCloud: true, users: false }],
...
function getDefaultPageForUser(user) {
  ...
  if (cleanUser?.permissions?.dashboard) return "dashboard";
  if (cleanUser?.permissions?.daily) return "daily";
  if (cleanUser?.permissions?.delivery) return "delivery";
  if (cleanUser?.permissions?.reports) return "reports";
  if (cleanUser?.permissions?.sales) return "sales";
...
export default function FuelTankPWAPrototype() {
  ...
  const canUsePage = (page) => Boolean(permissions[page]);
